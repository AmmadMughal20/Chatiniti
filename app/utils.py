...
def sendVerificationEmail(email, token):
    ...
    msg = Message('Verify your email', sender='ammadmughal567@gmail.com', recipients=[email])
...
def send_recovery_email_to_user(email, token):
    ...
    msg = Message('Reset your Chatiniti password', sender='ammadmughal567@gmail.com', recipients=[email])
